        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div>
            <h3 className="font-bold text-xl text-orange-500 mb-4">
              Congo<span className="text-foreground">.dev</span>
            </h3>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-start gap-3">
                ...
                <a href="tel:+233531878243" className="text-muted-foreground hover:text-orange-500 transition-colors">+233 531 878 243</a>
              </li>
              <li className="flex items-start gap-3">
                <Mail className="w-5 h-5 text-orange-500 mt-0.5 flex-shrink-0" />
                <a href="mailto:amusahcongo@gmail.com" className="text-muted-foreground hover:text-orange-500 transition-colors">amusahcongo@gmail.com</a>
              </li>
              <li className="flex items-start gap-3">
              ...
              <li className="flex items-start gap-3">
                ...
                <a href={resumeUrl} target="_blank" rel="noopener noreferrer" className="text-muted-foreground hover:text-orange-500 transition-colors">View Resume</a>
              </li>
            </ul>
          </div>
        </div>
