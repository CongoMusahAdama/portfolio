                ...
                <div className="py-8 px-4 relative">
                  ...
                  <div className="flex flex-col items-center text-center">
                    <img
                      ...
                      className="w-20 h-20 rounded-full object-cover mb-4 border-2 border-brand-pink/20"
                    />
                    <div>
          ...
          <div className="flex justify-center space-x-2 mt-8">
            {testimonials.map((_, index) => (
              <button
                ...
                className={`w-3 h-3 rounded-full transition-colors duration-300 ${currentSlide === index ? 'bg-brand-pink' : 'bg-muted-foreground/30'
                  }`}
