...
const TestimonialsSection = () => {
  ...
  return (
    <section id="testimonials" className="py-16 md:py-32 bg-secondary/30 scroll-mt-24">
      <div className="container mx-auto px-5 sm:px-6">
        <div className="text-center max-w-3xl mx-auto mb-12 md:mb-20">
          <motion.h2
            ...
            viewport={{ once: true }}
            className="text-2xl sm:text-3xl md:text-5xl font-black text-foreground mb-4 sm:mb-6 uppercase tracking-tight leading-tight"
          >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {testimonials.map((t, index) => (
            <motion.div
              ...
              className="bg-background p-6 sm:p-8 rounded-2xl border border-border/50 hover:border-brand-orange/30 transition-all duration-300 shadow-sm flex flex-col justify-between"
            >
              <div>
