...
const AboutSection = () => {
  return (
    <section
      id="about"
      className="relative py-12 md:py-16 bg-background overflow-hidden border-t border-border/40"
    >
            ...
            >
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8 text-sm md:text-base text-muted-foreground leading-relaxed font-medium">
                <p>
                  ...
                  based in Ghana. I bridge the gap between technical complexity,{" "}
                  <span className="text-foreground font-black">
                    Content Strategy
                  </span>
                  , and{" "}
                ...
                <p>
                  Outside of code, I'm an agricultural innovator and product
                  thinker, dedicated to creating solutions that serve diverse
                  industries and solve practical challenges.
                </p>
              </div>
                ...
                {[
                  {
                    ...
                    desc: "Robust, scalable backend architectures.",
                    icon: "M12 2L2 7l10 5 10-5-10-5zM2 17l10 5 10-5M2 12l10 5 10-5",
                  },
                  {
                    title: "Strategic Thinking",
                    desc: "Strategic thinking with intelligent details.",
                  ...
                  {
                    title: "Architectural",
                    desc: "Designing maintainable system structures.",
