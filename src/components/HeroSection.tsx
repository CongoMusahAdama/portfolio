...
const HeroSection = ({ profileImage }: HeroSectionProps) => {
  return (
    <section id="hero" className="relative bg-gray-900 min-h-screen pt-24 overflow-hidden">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-center">
          ...
          >
            ...
            >
              ...
              <span className="text-white">Congo Musah Adama</span>
            </motion.h1>
            <motion.h2 
            ...
            <div className="mt-8 flex flex-wrap gap-4">
              ...
              <a href="https://drive.google.com/file/d/1gejHNj4tP7kpchFHv0vUlJy4n-cpl31e/view?usp=sharing" target="_blank" rel="noopener noreferrer">
                <Button variant="outline" className="border-orange-500 text-orange-500 hover:bg-orange-50 hover:text-orange-600 py-2 px-6 rounded-md font-medium">
